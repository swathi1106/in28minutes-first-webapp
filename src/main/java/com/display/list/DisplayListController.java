...
public class DisplayListController {
	...
	@RequestMapping(value="/displayOne", method = RequestMethod.GET)
	public String showDisplayPageOne(Model model) {
		model.addAttribute("map", service.getDisplayMap());
		model.addAttribute("displayForm", new DisplayOneModel());
		return "displayone";
	}
